...
function setup() {
  ...
  imagen [0] = loadImage("imagenes/paleta0.jpg");
  imagen [1] = loadImage("imagenes/paleta1.jpg");
  imagen [2] = loadImage("imagenes/paleta2.jpg");
  imagen [3] = loadImage("imagenes/paleta3.jpg");
  imagen [4] = loadImage("imagenes/paleta4.jpg");
  imagen [5] = loadImage("imagenes/paleta5.jpg");
  imagen [6] = loadImage("imagenes/paleta6.jpg");
  imagen [7] = loadImage("imagenes/paleta7.jpg");
  imagen [8] = loadImage("imagenes/paleta8.jpg");
